...
public class PurchaseHistory {
	...
	{ // this is broken and won't work but I'm not going to figure out how to fix it right now
		PurchaseHistoryLoader myLoader = new PurchaseHistoryLoader(null, theItem.getUniqueID());
