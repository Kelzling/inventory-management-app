...
public class InventoryLoader extends FileLoader {
	...
	public InventoryLoader(String filesDir, String fileID, SystemManager theSystem) throws FileNotFoundException
	{
	...
	protected String getFilePath(String fileID) {
		...
		String path = this.filesDir + "/Data/Inventories/" + fileID + this.fileExtension;
